...
df_dyad <- df_dyad %>%
  mutate(
    ...
    # fit statistic error correction
    fit_p = pweightp * 10,
    fit_a = pweighta * 10
  )
...
log_1n_fit <- glm(formula=pos10s ~ indiv1 + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
log_2n_fit <- glm(formula=pos10s ~ indiv1 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
log_3n_fit <- glm(formula=pos10s ~ indiv1 + indiv3 + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
log_4n_fit <- glm(formula=pos10s ~ indiv1 + indiv3 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
log_5n_fit <- glm(formula=pos10s ~ proindex + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
log_6n_fit <- glm(formula=pos10s ~ proindex + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
logp_1n_fit <- glm(formula=pos10s ~ indiv1 + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
logp_2n_fit <- glm(formula=pos10s ~ indiv1 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
logp_3n_fit <- glm(formula=pos10s ~ indiv1 + indiv3 + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
logp_4n_fit <- glm(formula=pos10s ~ indiv1 + indiv3 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
logp_5n_fit <- glm(formula=pos10s ~ proindex + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
logp_6n_fit <- glm(formula=pos10s ~ proindex + pbelief + stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
null_mn_fit <- glm(formula=pos10s ~ stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
null_mn_zero_fit <- glm(formula=pos10s ~ 1,
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_p)
...
null_pn_fit <- glm(formula=pos10s ~ stats_brw + topic_brw + t2 + t3 + factor(backgr_degree),
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
null_pn_zero_fit <- glm(formula=pos10s ~ 1,
             data = df_dyad,
             family = binomial(link = "logit"),
             weights = fit_a)
...
Table_12[16,2:8] <- format(round( as.numeric(c((1-(logLik(null_mn_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_1n_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_2n_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_3n_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_4n_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_5n_fit)/logLik(null_mn_zero_fit))), (1-(logLik(log_6n_fit))/logLik(null_mn_zero_fit)))),3), nsmall = 3)

Table_12[14,2:8] <- round(c(logLik((null_mn_fit)), logLik(log_1n_fit), logLik(log_2n_fit), logLik(log_3n_fit), logLik(log_4n_fit), logLik(log_5n_fit), logLik(log_6n_fit)),2)

Table_12[15,2:8] <- round(c(AIC((null_mn_fit)), AIC(log_1n_fit), AIC(log_2n_fit), AIC(log_3n_fit), AIC(log_4n_fit), AIC(log_5n_fit), AIC(log_6n_fit)),2)
...
Table_12[32,2:8] <- format(round( as.numeric(c((1-(logLik(null_pn_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_1n_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_2n_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_3n_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_4n_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_5n_fit)/logLik(null_pn_zero_fit))), (1-(logLik(logp_6n_fit))/logLik(null_pn_zero_fit)))),3), nsmall = 3)

Table_12[30,2:8] <- round(c(logLik((null_pn_fit)), logLik(logp_1n_fit), logLik(logp_2n_fit), logLik(logp_3n_fit), logLik(logp_4n_fit), logLik(logp_5n_fit), logLik(logp_6n_fit)),2)

Table_12[31,2:8] <- round(c(AIC((null_pn_fit)), AIC(logp_1n_fit), AIC(logp_2n_fit), AIC(logp_3n_fit), AIC(logp_4n_fit), AIC(logp_5n_fit), AIC(logp_6n_fit)),2)
