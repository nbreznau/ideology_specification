...
m_1 <- lm.cluster(formula=AME ~ group1 + group3 + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = 1/df$nmodel, cluster = "u_teamid", data = df)

m_2 <- lm.cluster(formula=AME ~ group1 + group3 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = 1/df$nmodel, cluster = "u_teamid", data = df)

m_3 <- lm.cluster(formula=AME ~ proindex + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = 1/df$nmodel, cluster = "u_teamid", data = df)

m_4 <- lm.cluster(formula=AME ~ proindex + pbelief + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = 1/df$nmodel, cluster = "u_teamid", data = df)


p_1 <- lm.cluster(formula=AME ~ group1 + group3 + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = df$pscore/df$nmodel, cluster = "u_teamid", data = df)

p_2 <- lm.cluster(formula=AME ~ group1 + group3 + pbelief + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = df$pscore/df$nmodel, cluster = "u_teamid", data = df)

p_3 <- lm.cluster(formula=AME ~ proindex + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = df$pscore/df$nmodel, cluster = "u_teamid", data = df)

p_4 <- lm.cluster(formula=AME ~ proindex + pbelief + stats_brw + topic_brw + t2 + t3 + factor(mdegree), weights = df$pscore/df$nmodel, cluster = "u_teamid", data = df)
...
Table_2 <- as.data.frame(matrix(nrow = 32, ncol = 6))
...
#m_ models
Table_2[c(6,8),2] <- round(as.numeric(null_m$lm_res$coefficients[2:3]),3)
Table_2[c(7,9),2] <- sprintf("(%s)", round(as.numeric(summary(null_m)[2:3,2]),3))

Table_2[c(2,4,6,8),3] <- round(as.numeric(m_1$lm_res$coefficients[2:5]),3)
Table_2[c(3,5,7,9),3] <- sprintf("(%s)", round(as.numeric(summary(m_1)[2:5,2]),3))

Table_2[c(2,4,6,8,10),4] <- round(as.numeric(m_2$lm_res$coefficients[c(2,3,5,6,4)]),3)
Table_2[c(3,5,7,9,11),4] <- sprintf("(%s)", round(as.numeric(summary(m_2)[c(2,3,5,6,4),2]),3))

Table_2[c(6,8,12),5] <- round(as.numeric(m_3$lm_res$coefficients[c(3,4,2)]),3)
Table_2[c(7,9,13),5] <- sprintf("(%s)", round(as.numeric(summary(m_3)[c(3,4,2),2]),3))

Table_2[c(6,8,10,12),6] <- round(as.numeric(m_4$lm_res$coefficients[c(4,5,3,2)]),3)
Table_2[c(7,9,11,13),6] <- sprintf("(%s)", round(as.numeric(summary(m_4)[c(4,5,3,2),2]),3))


Table_2[16,2:6] <- c(r2ext(null_m), r2ext(m_1), r2ext(m_2), r2ext(m_3), r2ext(m_4))

Table_2[14,2:6] <- round(c(logLik((null_ml)), logLik(m_1l), logLik(m_2l), logLik(m_3l), logLik(m_4l)),2)

Table_2[15,2:6] <- round(c(AIC((null_ml)), AIC(m_1l), AIC(m_2l), AIC(m_3l), AIC(m_4l)),2)

#p_ models
Table_2[c(22,24),2] <- round(as.numeric(null_p$lm_res$coefficients[2:3]),3)
Table_2[c(23,25),2] <- sprintf("(%s)", round(as.numeric(summary(null_p)[2:3,2]),3))

Table_2[c(18,20,22,24),3] <- round(as.numeric(p_1$lm_res$coefficients[2:5]),3)
Table_2[c(19,21,23,25),3] <- sprintf("(%s)", round(as.numeric(summary(p_1)[2:5,2]),3))

Table_2[c(18,20,22,24,26),4] <- round(as.numeric(p_2$lm_res$coefficients[c(2,3,5,6,4)]),3)
Table_2[c(19,21,23,25,27),4] <- sprintf("(%s)", round(as.numeric(summary(p_2)[c(2,3,5,6,4),2]),3))

Table_2[c(22,24,28),5] <- round(as.numeric(p_3$lm_res$coefficients[c(3,4,2)]),3)
Table_2[c(23,25,29),5] <- sprintf("(%s)", round(as.numeric(summary(p_3)[c(3,4,2),2]),3))

Table_2[c(22,24,26,28),6] <- round(as.numeric(p_4$lm_res$coefficients[c(4,5,3,2)]),3)
Table_2[c(23,25,27,29),6] <- sprintf("(%s)", round(as.numeric(summary(p_4)[c(4,5,3,2),2]),3))

Table_2[32,2:6] <- c(r2ext(null_p), r2ext(p_1), r2ext(p_2), r2ext(p_3), r2ext(p_4))

Table_2[30,2:6] <- round(c(logLik((null_pl)), logLik(p_1l), logLik(p_2l), logLik(p_3l), logLik(p_4l)),2)

Table_2[31,2:6] <- round(c(AIC((null_pl)), AIC(p_1l), AIC(p_2l), AIC(p_3l), AIC(p_4l)),2)
...
df_dyad$pweight <- 1/(df_dyad$nmodel*df_dyad$team_size)

m_1d <- lm.cluster(formula=AME ~ factor(indiv) + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight, cluster = "u_teamid", data = df_dyad)

m_2d <- lm.cluster(formula=AME ~ factor(indiv) + pbelief + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight, cluster = "u_teamid", data = df_dyad)

m_3d <- lm.cluster(formula=AME ~ attitude_immigration_1 + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight, cluster = "u_teamid", data = df_dyad)

m_4d <- lm.cluster(formula=AME ~ attitude_immigration_1 + pbelief + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight, cluster = "u_teamid", data = df_dyad)


p_1d <- lm.cluster(formula=AME ~ factor(indiv) + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight*df_dyad$pscore, cluster = "u_teamid", data = df_dyad)

p_2d <- lm.cluster(formula=AME ~ factor(indiv) + pbelief + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight*df_dyad$pscore, cluster = "u_teamid", data = df_dyad)

p_3d <- lm.cluster(formula=AME ~ attitude_immigration_1 + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight*df_dyad$pscore, cluster = "u_teamid", data = df_dyad)

p_4d <- lm.cluster(formula=AME ~ attitude_immigration_1 + pbelief + stats_i + topic_i + t2 + t3 + factor(backgr_degree), weights = df_dyad$pweight*df_dyad$pscore, cluster = "u_teamid", data = df_dyad)
