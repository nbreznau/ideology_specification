...
f4a <- ggplot() +
  stat_density(data = df,
               aes(x = peer_mean_Z, group = index, color = factor(index), weight = peerweight), 
  ...
  theme_classic() +
geom_vline(xintercept = weighted.mean(df$peer_mean_Z[df$group1 == 1], w = df$peerweight[df$group1 == 1], na.rm = TRUE), color = colors[1], linetype = "dashed") +
geom_vline(xintercept = weighted.mean(df$peer_mean_Z[df$group2 == 1], w = df$peerweight[df$group2 == 1], na.rm = TRUE), color = colors[2], linetype = "dashed") +
geom_vline(xintercept = weighted.mean(df$peer_mean_Z[df$group3 == 1], w = df$peerweight[df$group3 == 1], na.rm = TRUE), color = colors[3], linetype = "dashed") +
  #xlim(-2.1,2) +
