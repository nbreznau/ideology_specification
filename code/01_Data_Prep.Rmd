...
df <- df %>%
  ...
  mutate(nmale = ifelse(u_teamid == 27, 0.6666667, nmale),
         std = AME/abs(z),
         d1 = ifelse(!is.na(backgr_degree1), as.numeric(backgr_degree1), 0),
         d2 = ifelse(!is.na(backgr_degree2), as.numeric(backgr_degree2), 0),
         d3 = ifelse(!is.na(backgr_degree2), as.numeric(backgr_degree2), 0),
         ...
         belief_cat = case_match(belief_hypothesis,
                                 ...
                                 "Mid" ~ 2,
                                 "High" ~ 3),
         nbelief = (ifelse(belief_H1_11<=2 & !is.na(belief_H1_11), 1, 0)) + 
           (ifelse(belief_H1_12<=2 & !is.na(belief_H1_12), 1, 0)) + 
           (ifelse(belief_H1_13<=2 & !is.na(belief_H1_13), 1, 0)),
         teamx = (ifelse(!is.na(belief_H1_11), 1, 0)) +
           (ifelse(!is.na(belief_H1_12), 1, 0)) +
           (ifelse(!is.na(belief_H1_13), 1, 0)),
         nbelief = (ifelse(belief_H1_11 < 2, 1, 0)) +
                      (ifelse(belief_H1_12 < 2, 1, 0)) +
                      (ifelse(belief_H1_13 < 2, 1, 0)),
