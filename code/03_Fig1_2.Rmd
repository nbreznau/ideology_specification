...
agg_png(here("results", "FigS1_RGB.png"), res = 144, width = 600, height = 500)
...
knitr::include_graphics(here("results", "FigS1_RGB.png"))
...
densityA <- ggplot(df, aes(x = AME)) +
  ...
  annotate("text", y = 30, x = coeff_group3 + weighted_mean_ame_group2m, label = paste(rank_coeff_group3,"th","\npercentile", sep = ""), hjust = 0, size = 2.5, color = colors_classic[3]) +
  xlim(-0.119,0.06) +
  theme_classic() +
  theme(
