...
f1a <- ggplot() +
  ...
  annotate("text", x = 1.2, y = 11.1, label = "71 teams independently used the same dataset to test a single\nhypothesis: that immigration reduces support for social policies", hjust = 0, size = 3.3, color = "grey30", vjust = 1) +
  annotate("text", x = 1.2, y = 8.9, label = "They were asked prior to their research tasks if immigration\nlaws in their country should be made stronger or more relaxed", hjust = 0,  vjust = 0.8, size = 3.3, color = "grey30", fontface = "italic") +
  # Add many analysts blurb
...
```{r fig1p}
agg_png(here("results", "Fig1A_RGB.png"), res = 144, height = 500, width = 800)
...
f1argb <- ggplot() +
  ...
  annotate("text", x = 3, y = 2, label = "Pro-immigration", hjust = 1, color = colors_classic[3], size = 3.5) +
  annotate("text", x = 3, y = 3, label = "Moderate", hjust = 1, color = colors_classic[2], size = 3.5) +
  annotate("text", x = 3, y = 4, label = "Anti-immigration", hjust = 1, color = colors_classic[1], size = 3.5) +
  annotate("text", x = 3, y = 1, label = "Total", hjust = 1, size = 3.5) +
  ...
  mapply(function(txt, x, y) {
    annotate("text", x = x, y = y, label = txt, color = colors_classic[1])}, 
    Table_1_model[1:4,3], x_positions, y_pos4) +
  mapply(function(txt, x, y) {
    annotate("text", x = x, y = y, label = txt, color = colors_classic[2])}, 
    Table_1_model[1:4,4], x_positions, y_pos3) +
  mapply(function(txt, x, y) {
    annotate("text", x = x, y = y, label = txt, color = colors_classic[3])}, 
    Table_1_model[1:4,5], x_positions, y_pos2) +
...
include_graphics(here("results", "Fig1A_RGB.png"))
```
...
```{r fig1brgb}
agg_png(here("results", "Fig1B_RGB.png"), res = 144, width = 600, height = 500)
...
knitr::include_graphics(here("results", "Fig1B_RGB.png"))
...
agg_png(here("results", "FigS1.png"), res = 144, width = 600, height = 500)
