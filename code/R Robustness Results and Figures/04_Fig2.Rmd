...
# Calculate the density for each index group and adjust y-axis positions to avoid overlap
...
# Plot using geom_density with the offset
...
#### Combine
```{r f4arrangergb}
agg_png(here("results", "Fig2A.png"), res = 288, height = 1600, width = 1600)
...
```{r 5brgb}
agg_png(here("results", "Fig2B.png"), res = 288, height = 1000, width = 1200)
