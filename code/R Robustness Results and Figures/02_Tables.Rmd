...
Main and reported regression analyses performed in Stata (see `reg_model.do` in this repository). The R workflow is an additional robustness check and used for visualizations. 
...
Table_FS2[,2] <- c(
  ...
  # Table 13
  numg(Table_13,4,3), numg(Table_13,4,4), (numg(Table_13,4,5) - numg(Table_13,2,5)), (numg(Table_13,4,6) - numg(Table_13,2,6)), numg(Table_13,12,7), numg(Table_13,12,8),
  numg(Table_13,20,3), numg(Table_13,20,4), (numg(Table_13,20,5) - numg(Table_13,18,5)), (numg(Table_13,20,6) - numg(Table_13,18,6)), numg(Table_13,28,7), numg(Table_13,28,8),
  # Table 4
...
Table_FS2[,3] <- c(
  ...
  # Table 13
  nums(Table_13,5,3), nums(Table_13,5,4), (nums(Table_13,5,5) - nums(Table_13,3,5)), (nums(Table_13,5,6) - nums(Table_13,3,6)), nums(Table_13,13,7), nums(Table_13,13,8),
  nums(Table_13,21,3), nums(Table_13,21,4), (nums(Table_13,21,5) - nums(Table_13,19,5)), (nums(Table_13,21,6) - nums(Table_13,19,6)), nums(Table_13,29,7), nums(Table_13,29,8),
  # Table 4
