...
```{r fig2a}
agg_png(here("results", "Fig4A.png"), res = 144, height = 300, width = 650)
...
plot_data_ame %>%
  ...
  labs(x = "Variables", y = "Marginal Effects\n(pos10s, nmodel weights, model-level)", title = "") +
...
```{r fig2c}
agg_png(here("results", "Fig4C.png"), res = 144, height = 300, width = 650)
...
plot_data_ame_dyad %>%
  ...
  geom_point() +
  geom_errorbar(aes(ymin = mean - 1.645 * se, ymax = mean + 1.645 * se), width = 0.1) +
  labs(x = "Variables", y = "Marginal Effects\n(pos10s, nmodel weights, indiv-model level)", title = "") +
  #geom_hline(yintercept = 0, linetype = "dotted", color = "grey") + 
  #ylim(-0.075,0.025) +
...
knitr::include_graphics(here("results", "Fig4C.png"))
```

### Fig4D Dyad Peer

```{r fig2d}
agg_png(here("results", "Fig4D.png"), res = 144, height = 300, width = 650)
...
knitr::include_graphics(here("results", "Fig4D.png"))
```
