...
#### Combine
```{r f4arrangergb}
agg_png(here("results", "Fig5A_RGB.png"), res = 144, height = 800, width = 800)
...
knitr::include_graphics(here("results", "Fig5A_RGB.png"))
```
...
df_mame[2,] <- c(2.75, "group3", coef_group3, se_group3, "Main model")
df_mame[3,] <- c(1.25, "group1", coef_group1m, se_group1m, "Residual")
df_mame[4,] <- c(1, "group3", coef_group3m, se_group3m, "Residual")
...
df_mame %>%
  ...
  geom_errorbar(aes(ymin = coef_group1, ymax = coef_group3, x = 2.75), width = 0.2, color = "grey30", linetype = "dashed", size = 0.5) +
  ...
  annotate("text", y = c(-0.1,
                         ...
                         coef_group1,
                         coef_group3), 
           x = c(3.2,1.7,2.9,2.35),
           label = c("Main models", "Residuals", "Anti-immigration", "Pro-immigration"),
