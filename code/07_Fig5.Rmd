...
f5b <- ggplot(df_long, aes(x = unique_combo_numeric, y = y)) +
...
ggarrange(f5a, f5b, ncol = 1, nrow = 2, align = "v", heights = c(3,2))
...
## Fig 6. Plot AME distribution

```{r plot}
agg_png(here("results", "Fig6.png"), res = 144, height = 650, width = 850)
